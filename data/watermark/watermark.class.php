...
function WaterMark($groundimage, $markimage , $markwhere='0', $marktext='', $fontfamily='黑体', $fontsize='15', $fontcolor="#000", $marktype=0)
{
	//配置水印图片文件
	if(!file_exists($markimage))
	{
		$markimage = SITE_DATA.'/watermark/watermarket.png';
	}
