...
function UploadFile($upfile, $iswatermark='')
{
	...
	{
		//return '请选择要上传的文件！';
		return '您上传的文件超过php.ini设定最大文件上传限制['.ini_get('upload_max_filesize').']！';
	}
	...
	if(@move_uploaded_file($tempfile_tn, $save_dir))
	{
		...
		{
			WaterMark($save_dir, SITE_ROOT.'/'.$cfg_markpicurl, $cfg_markwhere, $cfg_marktext, SITE_DATA.'/fonts/incite.ttf', $cfg_marksize, $cfg_markcolor, $cfg_marktype);
		}
