...
require_once(dirname(__FILE__).'/../../../../UaPlus/common.inc.php');require_once(SITE_DATA.'/watermark/watermark.inc.php'); ?>
...
<div class="W">
	...
	<div class="jcorp_pop">
		...
		<div class="jcorp_par">
			<form id="crop" action="crop.php" method="post" onsubmit="return CheckCoords();">
				<label>X1
...
$(function(){
	...
	$("#SaveBtn").click(function(){
		...
		$.ajax({
			url : "jcrop_do.php?imgurl=<?php echo $imgurl; ?>&x1="+ x1 +"&y1="+ y1 +"&x2="+ x2 +"&y2="+ y2 +"&iw="+ iw +"&ih=" + ih +"&wm=" + wm,
			type:'get',
			dataType:'html',
			beforeSend:function(){
			},
