...
RewriteRule ^(.*)/about-([0-9]+)-([0-9]+)\.html$ $1/about.php?id=$2&page=$3
RewriteCond %{QUERY_STRING} ^(.*)$
...
RewriteCond %{QUERY_STRING} ^(.*)$
RewriteRule ^(.*)/contact-([0-9]+)-([0-9]+)\.html$ $1/contact.php?id=$2&page=$3
RewriteCond %{QUERY_STRING} ^(.*)$
...
RewriteCond %{QUERY_STRING} ^(.*)$
RewriteRule ^about-([0-9]+)-([0-9]+)\.html$ about.php?id=$1&page=$2
RewriteCond %{QUERY_STRING} ^(.*)$
...
RewriteCond %{QUERY_STRING} ^(.*)$
RewriteRule ^contact-([0-9]+)-([0-9]+)\.html$ contact.php?id=$1&page=$2
RewriteCond %{QUERY_STRING} ^(.*)$
...
&lt;rule name="about"&gt;
	...
	&lt;action type="Rewrite" url="{R:1}/about.php\?id={R:2}&amp;amp;page={R:3}" /&gt;
&lt;/rule&gt;
&lt;rule name="news"&gt;
...
&lt;rule name="contact"&gt;
	...
	&lt;action type="Rewrite" url="{R:1}/contact.php\?id={R:2}&amp;amp;page={R:3}" /&gt;
&lt;/rule&gt;
&lt;rule name="soft"&gt;
...
rewrite ^([^\.]*)/about-([0-9]+)-([0-9]+)\.html$ $1/about.php?id=$2&page=$3 last;
...
rewrite ^([^\.]*)/contact-([0-9]+)-([0-9]+)\.html$ $1/contact.php?id=$2&page=$3 last;
