	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
		<tr>
			...
			<select name="parentid" id="parentid">
				...
				<?php ShowType('#@__adtype','#@__adtype','id'); ?>
			</select>
		...
		<tr>
			...
			<td><input type="text" name="width" class="class_input" id="width" style="width:80px;" />
				px　高度：
				<input type="text" name="height" class="class_input" id="height" style="width:80px;" />
				px <span class="maroon">*</span></td>
		</tr>
		<tr>
