...
if($action == 'add')
{
	...
	$sql = "INSERT INTO `$tbname` (classid, parentid, parentstr, mainid, mainpid, mainpstr, title, colorval, boldval, flag, filetype, softtype, language, accredit, softsize, unit, runos, website, demourl, dlurl, author, linkurl, keywords, description, content, picurl, picarr, orderid, hits, posttime, checkinfo {$fieldname}) VALUES ('$classid', '$parentid', '$parentstr', '$mainid', '$mainpid', '$mainpstr', '$title', '$colorval', '$boldval', '$flag', '$filetype', '$softtype', '$language', '$accredit', '$softsize', '$unit', '$runos', '$website', '$demourl', '$dlurl', '$author', '$linkurl', '$keywords', '$description', '$content', '$picurl', '$picarr', '$orderid', '$hits', '$posttime', '$checkinfo' {$fieldvalue})";
