	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
		...
		<tr class="nb">
			<td colspan="2" height="26" id="getattr">
				<div style="text-align:center;color:#9C0;">请选择商品类别获取自定义属性</div>
			</td>
		</tr>
		<tr class="nb">
			<td colspan="2" height="26"><div class="line"></div></td>
		...
		<tr>
			...
			<td><input type="radio" name="payfreight" value="0" checked="checked"  />
				买家承担&nbsp;
				<input type="radio" name="payfreight" value="1" />
				卖家承担</td>
		</tr>
		<tr>
			<td height="35" align="right">价　格：</td>
			<td><input name="marketprice" type="text" id="marketprice" class="class_input" style="width:50px;" />
				市场价　
				<input name="salesprice" type="text" id="salesprice" class="class_input" style="width:50px;" />
				销售价　
				<input name="memberprice" type="text" id="memberprice" class="class_input" style="width:50px;" />
				折扣价</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="weight" type="text" id="weight" class="input_short" />
				kg</td>
		</tr>
		<tr>
			<td height="35" align="right">库存数量：</td>
			<td><input name="housenum" type="text" id="housenum" class="input_short" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="warnnum" type="text" id="warnnum" class="input_short" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" name="orderid" id="orderid" class="input_short" value="<?php echo GetOrderID('#@__goods'); ?>" /></td>
		</tr>
		<tr>
