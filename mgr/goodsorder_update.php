...
<form name="form" id="form" method="post" action="goodsorder_save.php" onsubmit="return cfm_goodsorder();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
		...
		<tr >
			...
			<td><input name="province" type="text" class="class_input" id="province" value="<?php echo $row['province']; ?>" />
				<span class="maroon">*</span></td>
		</tr>
		<tr>
			<td height="35" align="right">城　市：</td>
			<td><input name="city" type="text" class="class_input" id="city" value="<?php echo $row['city']; ?>" />
				<span class="maroon">*</span></td>
		</tr>
		<tr>
		...
		<tr>
			<td height="35" align="right">配送地区：</td>
			<td><select name="postarea" id="postarea">
					<option value="-1">请选择配送地区</option>
					<?php ShowType('#@__postarea','#@__goodsorder','postarea'); ?>
				</select>
				<span class="maroon">*</span></td>
		</tr>
		<tr>
			...
			<td><select name="postmode" id="postmode">
					...
					<?php ShowNoneType('#@__postmode','#@__goodsorder','postmode'); ?>
				</select>
				<span class="maroon">*</span></td>
		</tr>
		<tr>
			...
			<td><select name="paymode" id="paymode">
					...
					<?php ShowNoneType('#@__paymode','#@__goodsorder','paymode'); ?>
				</select>
				<span class="maroon">*</span></td>
		</tr>
		<tr>
			...
			<td><select name="getmode" id="getmode">
					...
					<?php ShowNoneType('#@__getmode','#@__goodsorder','getmode'); ?>
				</select>
				<span class="maroon">*</span></td>
		</tr>
		<tr>
		...
		<tr>
			<td height="35" align="right">反馈积分：</td>
