...
<title>开发帮助中心</title>
<style type="text/css">
body{font-family:Verdana;font-size:12px;line-height:22px;margin:0;padding:20px;}
...
h1{margin-bottom:20px;padding-bottom:10px;border-bottom:1px solid #e5e5e5;line-height:32px;font-size:18px;color:#607280;}
h1 i{font-size:9px;}
...
.uselist h2{margin-bottom:5px;font-size:14px;color:#9C0;}
...
.gohome{position:absolute;right:20px;top:30px;font-size:14px;color:#0CF;}
...
<body>
<h1>网站代码使用说明</h1>
<a href="home.php" class="gohome">管理首页</a>
<div class="uselist">
	<h2>单页信息调用</h2>
	函数名称：<strong>Info($classid, $length=0, $gourl='')</strong><br />
	函数位置：include/func.class.php<br />
	函数说明：$classid 必填，栏目的id；$length 可空，字数显示，0或空为不限制；$gourl 可空，截取后跳转的连接。
	<h3>- 截取模式演示</h3>
	<em>&lt;?php echo Info(3,20); ?&gt;</em><br />
	百度，全球最大的中文搜索引擎、最大的中...
	<h3>- 截取有链接模式演示</h3>
	<em>&lt;?php echo Info(3,20,'http://www.baidu.com/'); ?&gt;</em><br />
	百度，全球最大的中文搜索引擎、最大的中...<a href="http://www.baidu.com/">[更多>>]</a>
	<h3>- 不截取模式演示</h3>
	<em>&lt;?php echo Info(3); ?&gt;</em><br />
	百度，全球最大的中文搜索引擎、最大的中文网站。2000年1月创立于北京中关村。<br />
...
<div class="uselist">
	...
	<div class="preline"></div>
	<div>具体方法：<strong>$dopage-&gt;GetPage($sql,$pagenum='')</strong><br />
		方法说明：获取分页信息，将数据序列分页<br />
		参数说明：$sql 必填，执行查询的SQL语句；$pagenum 必填，每页显示的记录数。
		<div class="preline"></div>
...
<div class="uselist">
	...
	<div>
		...
		函数说明：写入文件内容。
		<div class="preline"></div>
		函数名称：<strong>ReStrLen($sourcestr, $cutlength, $etc='...')</strong><br />
		参数说明：$sourcestr 为要截取的字符串；$cutlength 为要截取的长度；$etc 为截取后显示的样式，可省略，省略后为...。<br />
		函数说明：字符串截取函数。
		<div class="preline"></div>
...
<div class="uselist">
	...
	<div>目录名称：<strong>admin/</strong><br />
		...
		<span class="sdir">data/fonts/</span>水印类型选为文字后水印文字的字体目录<br />
		<span class="sdir">data/plugin/</span>插件存放目录<br />
		<span class="sdir">data/sessions/</span>session存放目录<br />
		<span class="sdir">data/update/</span>系统在线更新文件目录<br />
		<span class="sdir">data/upload/</span>上传文件类存在目录 <br />
		...
		目录说明：文件上传目录。
		<div class="preline"></div>
		目录名称：<strong>templets/</strong><br />
