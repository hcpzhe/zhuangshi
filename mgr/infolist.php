...
<body onload="GetList('infolist','<?php echo ($tid = isset($tid) ? $tid : ''); ?>','<?php echo $cutover_url; ?>')">
<div class="mgr_header"> <span class="title">列表信息管理</span>
		...
		<div class="alltype" onmouseover="ShowAllType();" onmouseout="HideAllType();">
				...
				<span><?php ShowType2('#@__infoclass',1); ?></span>
		</div>
		<?php
		}
		?>
...
<div id="recycle_window">
		<div class="recycle_window_header"><span class="recycle_window_title">信息列表回收站：</span> <span class="recycle_window_close"><a href="javascript:HideRecycle()"></a></span>
				<div class="cl"></div>
		</div>
