...
<form name="form" id="form" method="post" action="upload_filemgr_save.php">
	<div class="mgr_divt">
		<ul class="flag">
			<li>属性：</li>
			<li <?php if($mode=='sql') echo 'class="on_mode"'; ?>><a href="?mode=sql">数据模式</a></li>
			<li><span>|</span></li>
			<li <?php if($mode=='dir') echo 'class="on_mode"'; ?>><a href="?mode=dir">目录模式</a></li>
		</ul>
	</div>
	<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" class="mgr_table">
		...
		<tr align="center" class="mgr_tr">
			<td height="30"><input type="checkbox" name="checkid[]" id="checkid[]" value="<?php echo $gbfilename; ?>" <?php if($dirname == 'uploads/') echo 'disabled="disabled"'; ?> /></td>
...
<div class="mgr_divb">
	...
	共<strong style="padding:0 2px;"><?php echo $i; ?></strong>个文件 </div>
</body>
</html>