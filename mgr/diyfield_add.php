			...
			<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="nb">
					<tr>
						<td height="28"><input type="radio" name="fieldtype" id="fieldtype" value="varchar" checked="checked" />
							<strong>单行文本：</strong>字数较少，例如文章标题等；默认长度小于或等于 &quot;<span class="blue">255</span>&quot;</td>
					</tr>
					<tr>
						<td height="28"><input type="radio" name="fieldtype" id="fieldtype" value="text">
							<strong>多行文本：</strong>字数偏多，类似于文章描述形式的多行文本；<span class="blue">字段长度留空</span></td>
					</tr>
					<tr>
						<td height="28"><input type="radio" name="fieldtype" id="fieldtype" value="mediumtext">
							<strong>编 辑 器 ：</strong>字数较多，输入框带编辑器大型文本，如文章内容；<span class="blue">字段长度留空</span></td>
					</tr>
					<tr>
						<td height="28"><input type="radio" name="fieldtype" id="fieldtype" value="int">
							<strong>整　　数：</strong>正负整数类型字段，如123456；长度默认为 &quot;<span class="blue">11</span>&quot;</td>
					</tr>
					<tr>
						<td height="28"><input type="radio" name="fieldtype" id="fieldtype" value="radio">
							<strong>单选菜单：</strong><input type="text" name="fieldsel" id="fieldsel" style="width:300px;padding:2px;" value="" />
							默认长度小于或等于 &quot;<span class="blue">255</span>&quot;</td>
					</tr>
					<tr>
						<td height="28"><input type="radio" name="fieldtype" id="fieldtype" value="checkbox">
							<strong>多选菜单：</strong>在单选处填值，格式："选项=值"，每个选项用&quot;,&quot;分割；默认长度小于或等于 &quot;<span class="blue">255</span>&quot;</td>
					</tr>
					<tr>
						<td height="28"><input type="radio" name="fieldtype" id="fieldtype" value="select">
							<strong>下拉菜单：</strong>在单选处填值；默认长度小于或等于 &quot;<span class="blue">255</span>&quot;</td>
					</tr>
					<tr>
						<td height="28"><input type="radio" name="fieldtype" id="fieldtype" value="decimal">
							<strong>货　　币：</strong>如102.56；长度默认为 &quot;<span class="blue">10,2</span>&quot;，&quot;10&quot;代表值总长度，&quot;2&quot;代表小数位数</td>
					</tr>
					<tr>
						<td height="28"><input type="radio" name="fieldtype" id="fieldtype" value="datetime">
							<strong>日期时间：</strong>如2012-07-25 10:21:23，本系统日期格式为整型，所以系统会为您创建为整型字段；<span class="blue">字段长度留空</span></td>
					</tr>
					<tr>
					...
					<tr>
						<td height="28"><input type="radio" name="fieldtype" id="fieldtype" value="fileall">
							<strong>多个附件：</strong>可上传多个附件，类似于组图上传；<span class="blue">字段长度留空</span></td>
					</tr>
				</table></td>
		</tr>
		<tr>
