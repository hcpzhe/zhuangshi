...
<div class="mgr_header"> <span class="title">友情链接管理</span>
	<div class="alltype" onmouseover="ShowAllType();" onmouseout="HideAllType();"> <a href="?" class="btn">查看全部</a> <span>
		<?php ShowMgrType('#@__weblinktype'); ?>
		</span> </div>
...
<form name="form" id="form" method="post" action="weblink_save.php">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mgr_table">
		...
		<tr align="center" class="mgr_tr">
			...
			<td class="action"><span>[<a href="weblink_save.php?id=<?php echo $row['id']; ?>&action=check&checkinfo=<?php echo $row['checkinfo']; ?>" title="点击进行审核与未审操作"><?php echo $checkinfo; ?></a>]</span><span>[<a href="weblink_update.php?id=<?php echo $row['id']; ?>">修改</a>]</span><span>[<a href="weblink_save.php?action=del&id=<?php echo $row['id'] ?>" onclick="return ConfDel(1);">删除</a>]</span></td>
		</tr>
		<?php
		}	
		?>
