...
<form name="form" id="form" method="post" action="info_save.php">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
		<tr>
			<td width="25%" height="35" align="right">所属栏目名称：</td>
			<td width="75%">
				<strong>
				<?php
		...
		<tr>
			...
			<td><select name="mainid" id="mainid" onchange="GetMainType(this.value)">
					...
					<?php ShowType('#@__maintype','#@__info','mainid'); ?>
				</select>
		...
		<tr class="nb">
			...
			<td><?php
				if(isset($row['posttime']))
				{
					$posttime = GetDateTime($row['posttime']);
				}
				else
				{
					$posttime = GetDateTime(time());
				}
				?>
