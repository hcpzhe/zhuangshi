...
<div class="mgr_divt">
	...
	<div id="search" class="search">
		<form name="search_f" id="search_f" method="get" action="">
			<span class="s">
			<input name="keyword" id="keyword" type="text" title="输入文件名进行搜索" value="<?php echo @$keyword; ?>" />
			</span> <span class="b"><a href="javascript:;" onclick="search_f.submit();"><img src="templets/images/search_btn.png" title="搜索" /></a></span>
		</form>
	</div>
</div>
