...
<form name="form" id="form" method="post" action="maintype_save.php" onsubmit="return cfm_btype();">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
				<tr>
						<td width="25%" height="35" align="right">所属二级类别：</td>
						<td width="75%"><select name="parentid" id="parentid">
										<option value="0">默认分类</option>
										<?php ShowType('#@__maintype','#@__maintype','parentid'); ?>
								</select>
								<span class="maroon">*</span><span class="cnote">带<span class="maroon">*</span>号表示为必填项</span></td>
				</tr>
				<tr>
						<td height="35" align="right">类别名称：</td>
						<td><input type="text" name="classname" class="class_input" id="classname" value="<?php echo $row['classname']; ?>" />
