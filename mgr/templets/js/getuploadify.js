...
{
	$("body").append('<iframe frameborder="0" id="'+ frame +'" src="../data/plugin/uploadify/index.php?title='+ encodeURI(title) +'&type='+ type +'&desc='+ encodeURI(desc) +'&num='+ num +'&size='+ size +'&frame='+ frame +'&input='+ input +'&area='+ area +'" allowtransparency="true" class="uploadframe" scrolling="no"></iframe>');
