...
function bindLockScreen(){
	$(".lockscreen").bind("click",function(){
		$("body").append("<div id=\"lockscreen_bg\"> </div><div id=\"lockscreen_win\"><div id=\"lockscreen_pwd\"><label>密码：</label><input type=\"password\" id=\"password\" /><input id=\"lockscreen_btn\" type=\"image\" src=\"templets/images/lockscreen_enter.png\" onclick=\"CheckPwd()\" /><div id=\"lockscreen_note\"></div></div></div><div id=\"lockscreen_copy\">© 2012</div>")
