...
function ShowReWin(reid)
{
	...
	$("#graybg").show();
	$("#popup_window").show();
	$("#msg_area").html('<form name="form" id="form" method="post"><textarea name="msg" id="msg" class="smgarea" onkeyup="CkReMsgLen(this);">'+ cont +'</textarea><a href="javascript:;" onclick="ReMsg();" class="sendbtn"><img src="templets/images/remessage.gif" /></a><span id="length"></span></form>');
}
