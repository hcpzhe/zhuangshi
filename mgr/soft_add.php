...
<body>
<div class="gray_header"> <span class="title">软件信息添加</span> <span class="reload"><a href="javascript:location.reload();">刷新</a></span> </div>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
		...
		<tr>
			...
			<td><select name="mainid" id="mainid">
					...
					<?php ShowType('#@__maintype','#@__soft','mainid'); ?>
				</select>
		...
		<tr>
			...
			<td><select name="language" id="language" style="width:100">
		...
		<tr>
			...
			<td><input type="text" name="softsize" id="softsize" class="input_short" />
		...
		<tr>
			...
			<td><input type="text" name="runos" id="runos" value="Win7/WinXP/WinNT" class="class_input" /></td>
		</tr>
		<tr>
			<td height="35" align="right">官方网站：</td>
			<td><input type="text" name="website" id="website" class="class_input" /></td>
		</tr>
		<tr>
			<td height="35" align="right">演示地址：</td>
			<td><input type="text" name="demourl" id="demourl" class="class_input" /></td>
		</tr>
		<tr>
			<td height="35" align="right">下载地址：</td>
			<td><input type="text" name="dlurl" id="dlurl" class="class_input" />
		...
		<tr>
			...
			<td><input type="text" name="orderid" id="orderid" class="input_short" value="<?php echo GetOrderID('#@__soft'); ?>" /></td>
		</tr>
		<tr>
