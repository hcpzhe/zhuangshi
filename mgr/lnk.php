...
<form name="form" id="form" method="post" action="lnk_save.php?action=save">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mgr_table">
		...
		<tr align="left" class="mgr_tr">
			...
			<td align="center"><a href="lnk_save.php?id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=up"><img src="templets/images/up.gif" title="向上移动" /></a>
				<input name="orderid[]" type="text" id="orderid[]" class="input_gray_short" value="<?php echo $row['orderid']; ?>" />
				<a href="lnk_save.php?id=<?php echo $row['id']; ?>&orderid=<?php echo $row['orderid']; ?>&action=down"><img src="templets/images/down.gif" title="向下移动" /></a></td>
...
<div class="mgr_divb">
	...
	<span class="mgr_btn_short"><a href="javascript:void(0);" onclick="form.submit();return false;">更新全部</a><a href="home.php" style="margin-right:5px;">返回首页</a></span></div>
<div class="page_area">
