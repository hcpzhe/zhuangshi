...
<form name="form" id="form" method="post" action="?action=import">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mgr_table">
		...
		<tr align="center" class="mgr_tr" onmouseover="this.className='mgr_tr_on'" onmouseout="this.className='mgr_tr'">
			...
			<td class="action"><span>[<a href="?action=import&dopost=reset&dirname=<?php echo $tbname; ?>&tbname=<?php echo $s['name']; ?>">还原</a>]</span><span>[<a href="?action=import&dopost=del&dirname=<?php echo $tbname; ?>&tbname=<?php echo $s['name']; ?>">删除</a>]</span></td>
		</tr>
		<?php 
			}
			$conut = count($bfiles);
