...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mgr_table" id="ajaxlist">
		...
		<tr align="center" class="mgr_tr" onmouseover="this.className='mgr_tr_on'" onmouseout="this.className='mgr_tr'">
				...
				<td class="action"><span id="check<?php echo $row['id']; ?>">[<a href="javascript:;" title="点击进行审核与未审操作" onclick="CheckInfo(<?php echo $row['id']; ?>,'<?php echo $checkinfo; ?>')"><?php echo $checkinfo; ?></a>]</span><span>[<a href="infolist_update.php?tid=<?php echo $tid; ?>&id=<?php echo $row['id']; ?>">修改</a>]</span><span>[<a href="javascript:;" onclick="ClearInfo(<?php echo $row['id']; ?>)">删除</a>]</span></td>
		</tr>
		<?php
		}	
		?>
