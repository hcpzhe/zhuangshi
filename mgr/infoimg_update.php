...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
		...
		<tr>
			...
			<td><select name="mainid" id="mainid">
					...
					<?php ShowType('#@__maintype','#@__infoimg','mainid'); ?>
				</select>
		...
		<tr>
			...
			<td><input type="text" name="price" id="price" class="class_input" value="<?php echo $row['price']; ?>" /></td>
		</tr>
		<tr>
			<td height="35" align="right">作　者：</td>
			<td><input type="text" name="author" id="author" class="class_input" value="<?php echo $row['author']; ?>" /></td>
		</tr>
        <tr>
			<td height="35" align="right">设计师级别：</td>
