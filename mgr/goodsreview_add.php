...
<body>
<div class="gray_header"> <span class="title">添加商品评论</span> <span class="reload"><a href="javascript:location.reload();">刷新</a></span> </div>
<form name="form" id="form" method="post" action="goodsreview_save.php" onsubmit="return cfm_review();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
		...
		<tr>
			...
			<td><input type="text" name="nickname" id="nickname" class="input_short" />
				<span class="maroon">*</span></td>
		</tr>
		<tr class="nb">
			<td height="116" align="right">评论内容：</td>
			<td><textarea name="content" id="content" class="class_areatext"></textarea>
				<span class="maroon">*</span></td>
		</tr>
		<tr class="nb">
		...
		<tr>
			...
			<td><input type="text" name="orderid" id="orderid" class="input_short" value="<?php echo GetOrderID('#@__goodsreview'); ?>" /></td>
		</tr>
		<tr>
