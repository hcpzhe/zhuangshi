...
<div class="uploading" style="line-height:21px;"><span style="color:#999;">仅支持 gif / jpg / png / bmp 格式</span></div>
</body>
</html>
<?php
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	{
		echo '<script>UploadPrompt("请选择要上传的水印文件！");</script>';
		exit();
	}
	...
	if(!in_array($file_type_name, array('gif','jpg','png','bmp'))) //检查文件类型
	{
	...
	$file_upload_name = SITE_DATA.'/watermark/watermarket.'.$file_type_name; //构建上传服务器后文件地址
