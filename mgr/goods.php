...
<body onload="GetList('goods','<?php echo ($tid = isset($tid) ? $tid : ''); ?>','<?php echo $cutover_url; ?>')">
<div class="mgr_header"> <span class="title">商品信息管理</span>
		<?php 
		...
		<div class="alltype" onmouseover="ShowAllType();" onmouseout="HideAllType();">
				...
				<span><?php ShowType2('#@__goodstype'); ?></span>
		</div>
		<?php
		}
		?>
...
<div id="recycle_window">
		<div class="recycle_window_header"><span class="recycle_window_title">商品列表回收站：</span> <span class="recycle_window_close"><a href="javascript:HideRecycle()"></a></span>
				<div class="cl"></div>
		</div>
